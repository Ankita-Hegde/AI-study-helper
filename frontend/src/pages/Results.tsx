...
export default function Results() {
    ...
    return (
        <div className="h-screen flex flex-col bg-white overflow-hidden font-sans text-slate-800">
            {/* Header */}
            <div className="sticky top-0 h-16 border-b border-slate-200 flex items-center justify-between px-6 bg-white z-30">
                ...
                <div className="w-1/2 flex flex-col bg-slate-50/30">
                    ...
                    <div className="flex-1 overflow-hidden relative flex flex-col">
                        {activeTab === 'chat' ? (
                            ...
                            //     <div className="flex-1 overflow-y-auto p-8 pt-12 flex items-start justify-center bg-slate-50">
                            ...
                            //                         }`}
                            //                 >
                            //                     <div className="w-full overflow-auto max-h-[180px] text-left">
                            //                         <p className={`text-lg font-medium break-words ${flippedCards[i] ? 'text-white' : 'text-slate-800'} px-2 whitespace-normal`}>
                            ...
                            <div className="flex-1 overflow-y-auto p-8 pt-12 flex items-start justify-center bg-slate-50">
                                <div className="w-full max-w-md space-y-6">
                                    {data.flashcards.map((fc: any, i: number) => (
                                        ...
                                        >
                                            <div
                                                className={`flip-card-inner relative border rounded-2xl min-h-[200px] cursor-pointer transition-all group ${flippedCards[i] ? 'flipped shadow-lg' : 'shadow-sm'
                                                    }`}
                                            >
                                                {/* FRONT (Question) */}
                                                <div className="flip-card-face absolute inset-0 bg-white border-slate-200 text-slate-800 rounded-2xl flex flex-col items-center justify-center p-8">
                                                    <div className="w-full overflow-auto max-h-[180px] text-left">
                                                        <p className="text-lg font-medium break-words px-2 whitespace-normal">
                                                            {fc.front}
                                                        </p>
                                                    </div>
                                                    <p className="text-xs mt-4 font-medium uppercase tracking-wider text-slate-400">
                                                        Question
                                                    </p>
                                                    <div className="absolute top-4 right-4 opacity-0 group-hover:opacity-100 transition-opacity">
                                                ...
                                                {/* BACK (Answer) */}
                                                <div className="flip-card-face flip-card-back absolute inset-0 bg-blue-600 border-blue-600 text-white rounded-2xl flex flex-col items-center justify-center p-8">
                                                    <div className="w-full overflow-auto max-h-[180px] text-left">
                                                        <p className="text-lg font-medium break-words px-2 whitespace-normal">
                                                            {fc.back}
                                                        </p>
                                                    </div>
                                                    <p className="text-xs mt-4 font-medium uppercase tracking-wider text-blue-200">
                                                        Answer
                                                    </p>
                                                    <div className="absolute top-4 right-4 opacity-0 group-hover:opacity-100 transition-opacity">
                                                        <div className="p-2 rounded-full bg-blue-500 text-blue-100">
                                                            <Layers className="w-4 h-4" />
                                                        </div>
                                                    </div>
                                                </div>
